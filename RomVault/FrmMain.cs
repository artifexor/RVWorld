...
namespace ROMVault
{
    public partial class FrmMain : Form
    {
        ...
        private void Finish()
        {
            ...
            btnUpdateDats.BackgroundImage = (Image)resources.GetObject("btnUpdateDats.BackgroundImage");
            btnScanRoms.BackgroundImage = (Image)resources.GetObject("btnScanRoms.BackgroundImage");
            btnFindFixes.BackgroundImage = (Image)resources.GetObject("btnFindFixes.BackgroundImage");
            btnFixFiles.BackgroundImage = (Image)resources.GetObject("btnFixFiles.BackgroundImage");
